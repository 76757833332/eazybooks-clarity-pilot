...
const AppLayout: React.FC<AppLayoutProps> = ({ children, title }) => {
  return (
    <div className="flex h-screen bg-gradient-to-br from-background to-eazybooks-purple-dark/80 dark:from-black dark:to-eazybooks-purple-dark/80 light:from-white light:to-blue-50/40">
      <Sidebar />
